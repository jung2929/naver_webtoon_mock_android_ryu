...
public class WebtoonData implements Serializable {
    ...
    public WebtoonData(String thumbnail, String comicName, String comicRating, String storyWriter) {
    ...
    public WebtoonData(int comicNO, String comicName, String storyWriter, String painter, String thumbnail, String comicExplain, String comicDay, int comicHeart, String comicRating) {
