...
public class LoginActivity extends AppCompatActivity {
    ...
    private String firebaseTokenString;
        ...
        FirebaseInstanceId.getInstance().getInstanceId()
                .addOnSuccessListener(this, new OnSuccessListener<InstanceIdResult>() {
                    ...
                    public void onSuccess(InstanceIdResult instanceIdResult) {
                      firebaseTokenString =instanceIdResult.getToken();
                      Log.d("토큰 : ", firebaseTokenString);
                    }
                });
    }
    ...
    private void requestLogin() {
        ...
        for (int i = 0; i < 2; i++)
            userInput[i] = new String(etLoginInput[i].getText().toString());
        ...
        RequestLoginData loginData =
                new RequestLoginData(userInput[ID_INPUT], userInput[PW_INPUT], "");
        Call<ResponseLoginData> loginCall = Singleton.softcomicsService.login(loginData);
    ...
    private void toSignUpActivitySetting() {
